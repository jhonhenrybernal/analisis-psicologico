<template>
  <div>
    <div class="mt-5 pt-3">
      ...
      <image-assessment-table
        v-if="view == 'image-assessment-table'"
      ></image-assessment-table>
      ...
      if (e.status) {
        ...
        if (e.params.action === "acceso") {
          Swal.fire({
            title: "Hola!",
            text:
              "Tienes una nueva valoracion del paciente " +
              e.params.nombrePaciente,
            icon: "info",
            ...
            if (result.isConfirmed) {
              this.$router.push({
                ...
                params: { id: e.params.idValoracion },
              });
